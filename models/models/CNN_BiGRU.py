...
# using output from CNN as input for BiGRU
...
class CNN_GRU(nn.Module):
	def __init__(self, **kwargs):
		...
		self.GRU = nn.GRU(self.FILTER_NUM * len(self.FILTERS), self.HIDDEN_DIM, dropout=self.DROPOUT_PROB, num_layers=self.NUM_LAYERS, bidirectional=True)
