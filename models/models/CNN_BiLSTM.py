...
# use CNN output as input for BiLSTM
...
class CNN_BiLSTM(nn.Module):
	def __init__(self, **kwargs):
		...
		self.LSTM = nn.LSTM(self.FILTER_NUM * len(self.FILTERS), self.HIDDEN_DIM, dropout=self.DROPOUT_PROB, num_layers=self.NUM_LAYERS, bidirectional=True)
